...
| R7  | Materiais          | Ocorrer falha em notebook e não possuir reserva                          | Baixo         | Alto    | Médio | Realizar ação preventiva e corretiva, com manutenção periódica            | Utilizar uma maquina pessoal                                          |
...
| R9  | Segurança          | A aplicação sofrer ataques de invasão ocosionado por vunerabilidade do código | Médio         | Alto    | Alto  | Realizar revisões do código e manter os servidores atualizados            | Realizar shutdown o servidor, corrigir o código e subir o backup               |
